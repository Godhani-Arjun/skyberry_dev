class PredictiveSearch extends SearchForm {
  ...
  let currentScrollPosition = window.pageYOffset; // Save current scroll position
document.querySelector('input[type="search"]').addEventListener('focus', function(event) {
    event.preventDefault();  // Prevent the default focus behavior
    window.scrollTo(0, currentScrollPosition);   // Scroll back to the original position
});
